...
beautiful.init("/home/ant/.config/awesome/theme.lua")
...
-- {{{ Autostart
-- run_once prevents auto-started applications from respawning
...
-- and now the actual autostart programs
